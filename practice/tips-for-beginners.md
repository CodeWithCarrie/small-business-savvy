...
In cases where I have my own images saved on my Google Drive, I am able to use them by grabbing the specific id and forming the url like this: `https://drive.google.com/thumbnail?id=xyz&w=500`. (Note: The `w` parameter represents the width of the image you want to import in pixels. Make it larger than you need but not too large or it will take longer to load on the page.)
